...
export default function UniversityDetailPage2({ params }: Props) {
  ...
  const handleRegisterClick = async () => {
    ...
    try {
      ...
      if (!mrRes.ok) {
        toast.error(
          "MRUser үүсгэхэд алдаа гарлаа: " + (mrData.error || mrData.message)
        );
        return;
      }
      ...
      if (!res.ok || result.error) {
        toast.error(
          "Өргөдөл гаргах явцад алдаа гарлаа: " +
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              {[...Array(3)].map((_, i) => (
                <div
                  key={i}
                  className="p-6 rounded-xl border border-gray-200 dark:border-gray-800 space-y-4"
                >
      ...
      <div className="bg-white dark:bg-black dark:border-gray-800 border-b border-gray-200">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center gap-2 text-sm">
            <a
              href="/"
              className="text-sky-600 dark:text-sky-600  font-medium  hover:text-gray-900"
            >
              Нүүр хуудас
            </a>
            <ChevronRight className="w-4 h-4 text-gray-400" />
            <span className="text-gray-900 font-medium dark:text-white">
              {university?.name ? university.name : "Монгол улсын их сургууль"}
            </span>
          </div>
        </div>
      </div>
  ...
  "
        ...
        <div className="px-6 py-16 bg-linear-to-br from-slate-600/90 to-slate-900/90 dark:from-gray-900/90 dark:to-gray-800/90">
          <div className="mx-auto max-w-7xl">
            <div className="flex items-start gap-4 mb-6">
              ...
              <Badge
                variant="secondary"
                className="bg-gray-600/50 text-white border-gray-500 dark:bg-gray-700/50 dark:text-gray-100 dark:border-gray-600"
              >
            ...
            <div className="flex items-end justify-between">
              <div>
                <h1 className="text-5xl font-bold text-white mb-3 dark:text-gray-100">
                  {university?.name ?? "Монгол улсын их сургууль"}
                </h1>
              ...
              <div className="flex gap-3">
                ...
                >
                  <Button
                    variant="outline"
                    className="bg-white/10 border-white/20 text-white hover:bg-white/20 dark:bg-gray-700/20 dark:border-gray-600 dark:text-gray-100 dark:hover:bg-gray-700/40"
                  >
                ...
                <Dialog open={open} onOpenChange={setOpen}>
                  <DialogContent className="sm:max-w-md bg-white dark:bg-gray-900 dark:text-gray-100">
                    ...
                    <div className="flex flex-col items-center text-center gap-4">
                      ...
                      <Button
                        className="w-full bg-cyan-500 hover:bg-cyan-600 text-white dark:bg-cyan-600 dark:hover:bg-cyan-700"
            ...
            {activeTab === "overview" && (
              <section>
                ...
                <section>
                  ...
                  <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed text-[24px]">
                    {university?.name
                      ? university.name
                  ...
                  <div className="space-y-4 text-gray-700 dark:text-gray-300 font-bold leading-relaxed">
                    {university?.city ? university.city : "Улаанбаатар"}
                  </div>
              ...
              <section>
                ...
                <ul className="grid gap-6 md:grid-cols-2">
                  {data2.map((item, i) => (
                    <li
                      key={i}
                      className="border rounded-xl overflow-hidden bg-white dark:bg-gray-900 hover:shadow-md transition"
                    >
                      {item.image && (
                        <img
                          src={item.image}
    ...
    `}
            ...
            <Card className="p-6 dark:bg-gray-900">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">
                    ...
                    <span className="text-sky-500"> байхгүй байсанч болно</span>
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-sky-600 shrink-0" />
              ...
              <Button
                variant="link"
                className="w-full mt-4 text-sky-500 p-0 justify-start"
              >
                Бүрэн жагсаалт үзэх
            ...
            <Card className="p-6 dark:bg-gray-900">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <a
                    href="tel:6507232091"
                    className="text-sm text-gray-700 hover:text-sky-500  dark:text-gray-400 dark:hover:text-sky-500"
                  >
                    (976) 7023-2091
                  </a>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-gray-700 dark:text-gray-400 dark:hover:text-sky-500">
